var wechartJson = [
    ...
    // 业务申请编号
    {
        ...
        subject_information: true, // true代表主体信息已经填写完成并且正确；
        business_information: true, // true代表经营信息已经填写完成并且正确；
        settlement_rules: true, // true代表结算规则已经填写完成并且正确
        settlement_account: true, // true 代表结算账户已经完成并且填写正确     
        super_administrator: false, // true 代表超级管理员已经完成并且填写正确
        ...
        leixing: [
            {
                ...
                business_information: true, // true代表经营信息已经填写完成并且正确；
                settlement_rules: true, // true代表结算规则已经填写完成并且正确
                settlement_account: false, // true 代表结算账户已经完成并且填写正确     
                super_administrator: false, // true 代表超级管理员已经完成并且填写正确
            },
            {
                subject_information: true, // true代表主体信息已经填写完成并且正确；
                business_information: true, // true代表经营信息已经填写完成并且正确；
                settlement_rules: false, // true代表结算规则已经填写完成并且正确
                settlement_account: false, // true 代表结算账户已经完成并且填写正确     
                super_administrator: false, // true 代表超级管理员已经完成并且填写正确
            },
            {
            ...
            {
                subject_information: true, // true代表主体信息已经填写完成并且正确；
                business_information: false, // true代表经营信息已经填写完成并且正确；
                settlement_rules: false, // true代表结算规则已经填写完成并且正确
                settlement_account: false, // true 代表结算账户已经完成并且填写正确     
                super_administrator: false, // true 代表超级管理员已经完成并且填写正确
            }
        ...
        Idcard_or_openid: false, // false 是身份证
        business_scenario: [], // 经营场景信息     
        zhuti_leixing: null, // 赋值给已选主体类型的字段
        zhuti_leixing_ziduan: null
    ...
    // 超级管理员信息
    {
        ...
        subobject: [{
                ...
                value: null, // 组件值
                fieldType: "text",
                component_type: 'contact_name',
                generate_component: null,
                verification_type: 'contact_name_type',
...

            {
                ...
                caption: '超级管理员身份   证件号码',
                value: null,
                fieldType: "text",
                component_type: 'contact_id_number',
                generate_component: null,
                verification_type: "contact_id_number_type",
                verification_method: null,
                encryption_type: null,
                encryption_method: null,
                is_it_required: true,
...

            {
                ...
                value: null,
                fieldType: "text",
                component_type: 'openid',
                generate_component: null,
                verification_type: "openid_type",
                verification_method: null,
                encryption_type: null,
                encryption_method: null,
                is_it_required: true,
...

            {
                ...
                value: null,
                fieldType: "text",
                component_type: 'mobile_phone',
                generate_component: null,
                verification_type: "mobile_phone_type",
                verification_method: null,
                encryption_type: null,
                encryption_method: null,
                is_it_required: true
            },
            {
                ...
                value: null,
                fieldType: "text",
                component_type: 'contact_email',
                generate_component: null,
                verification_type: "contact_email_type",
                verification_method: null,
                encryption_type: null,
                encryption_method: null,
                is_it_required: true
            ...
            },
            {
                ...
                subobject: [ // 登记证书
                    ...
                    },
                    {
                        ...
                        value: null,
                        fieldType: "text",
                        component_type: "cert_type",
                        generate_component: null,
                        verification_type: "cert_type_type",
                        verification_method: null,
                        encryption_type: null,
                        encryption_method: null,
                        is_it_required: true,
    ...
    // 结算规则
    {
        ...
        subobject: [{
            ...
            },
            {
                ...
                value: null,
                fieldType: "text",
                component_type: 'activities_id',
                generate_component: null,
                verification_type: 'activities_id_type',
                verification_method: null,
                encryption_type: null,
                encryption_method: null,
                is_it_required: true // 条件选填 
            },
            {
                ...
                value: null,
                fieldType: "text",
                component_type: 'activities_rate',
                generate_component: null,
                verification_type: 'activities_rate_type',
                verification_method: null,
                encryption_type: null,
                encryption_method: null,
                is_it_required: true // 条件选填 
            },
            {
                ...
                component_type: 'activities_additions', // 上传的是照片
                generate_component: null,
                verification_type: null,
                verification_method: null,
                encryption_type: null,
    ...
    // 结算账户
    {
        ...
        subobject: [{
                ...
                value: null,
                fieldType: "text",
                component_type: 'bank_account_type',
                generate_component: null,
                verification_type: null,
                verification_method: null,
                encryption_type: null,
            ...
            },
            {
                ...
                value: null,
                fieldType: "text",
                component_type: "account_bank",
                generate_component: null,
                verification_type: 'account_bank_type',
                verification_method: null,
                encryption_type: null,
                encryption_method: null,
                is_it_required: true,
                other_banks: null, // 其他银行
                data_value_type: null // 这个值如果不为空代表选择的是其他银行；
            },
            {
                ...
                value: null,
                fieldType: "text",
                component_type: "bank_address_code",
                generate_component: null,
                verification_type: 'biz_address_code_type',
                verification_method: null,
                encryption_type: null,
...

            {
                ...
                value: null,
                fieldType: "text",
                component_type: "bank_branch_id",
                generate_component: null,
                verification_type: 'bank_branch_id_type',
                verification_method: null,
                encryption_type: null,
                encryption_method: null,
                is_it_required: true,
...

            {
                ...
                value: null,
                fieldType: "text",
                component_type: "account_number",
                generate_component: null,
                verification_type: 'account_number_type',
                verification_method: null,
                encryption_type: null,
                encryption_method: null,
                is_it_required: true,
